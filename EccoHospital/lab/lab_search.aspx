<%@ Page Language="C#" AutoEventWireup="true" masterPageFile="~/lab/MasterPage.Master" CodeBehind="lab_search.aspx.cs" Inherits="EccoHospital.lab.lab_search" %>
                               ...
                               <td><%
                                ...
                                <td>
                                 <% if (item.status == false)
                                    ...
                                    <a href="lab_search.aspx?p_id=<%=item.p_id %>&&edittxt=<%=item.id%>"  data-toggle="tooltip"
                                  ...
                                  <td>
                                     <a href="lab_search.aspx?p_id=<%=item.p_id %>&&edit=<%=item.id%>"  data-toggle="tooltip"
