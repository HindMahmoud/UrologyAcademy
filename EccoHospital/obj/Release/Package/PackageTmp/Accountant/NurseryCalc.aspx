<%@ Page Title="" Language="C#" MasterPageFile="~/Accountant/Home.Master" AutoEventWireup="true" CodeBehind="NurseryCalc.aspx.cs" Inherits="EccoHospital.Accountant.NurseryCalc" %>
    ...
    <div class="main_content_container">
        <div class="main_container  main_menu_open">
            ...
            <div class="page_content">
                                <h1 class="heading_title">حساب حضان  </h1>
                            ...
                            <tr style="background-color:#dcd7d7">
                             ...
                             <%  EccoHospital.Models.EccoHospitalEntities db = new EccoHospital.Models.EccoHospitalEntities();
                                 ...
                                 var x = (from p in db.patient_history
                                          ...
                                          where p.type=="حضانه"&& p.date>=d &&p.date<dplus
                               ...
                               <td><%=item.p.p_name %></td>
                                ...
                                <td><%=item.from_date %></td>
                                 ...
                                 <td>
                                     ...
                                     <a href="NurseryCalc.aspx?print=<%=item.p.id%>" class="glyphicon glyphicon-print" data-toggle="tooltip"
                                 ...
                                 <td>
                                     ...
                                     <a href="NurseryCalc.aspx?edit=<%=item.p.id%>" class="glyphicon glyphicon-edit" data-toggle="tooltip"
                                       data-placement="top" title="تعديل"></a>
                                </td>
                                
                                <td>
                                    
                                     <a href="NurseryCalc.aspx?id=<%=item.p.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
