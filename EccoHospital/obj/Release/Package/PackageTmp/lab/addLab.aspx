<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/lab/MasterPage.Master" CodeBehind="addLab.aspx.cs" Inherits="EccoHospital.lab.addLab" %>
            ...
            <div class="main_container  main_menu_open">
                ...
                <div class="home_pass hidden-xs">
                    <ul>
                        ...
                        <li class="bring_right"><a href="">إدارة معمل</a></li>
                        <li class="bring_right"><a href="">إضافة تحليل جديد</a></li>
                    </ul>
                </div>
                <!--/End system bath-->
                <div class="page_content">

                    <h1 class="heading_title">إضافة تحليل جديد</h1>


                    <!--Start status alert-->
                    <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="lab.aspx" class="alert-link">حسناً</a> . </div>
                    ...
                    <div>
                        <h1 class="heading_title">عرض كل المعامل</h1>
                    
                    <!--Start status alert-->
                    <div runat="server" visible="false" id="Div1" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="addLab.aspx" class="alert-link">حسناً</a> . </div>
                        ...
                        <table class="table table-bordered">
                           ...
                           %> 
                            <tr>
                                ...
                                <td>
                                    <a href="addLab.aspx?edit=<%=item.id%>" class="glyphicon glyphicon-pencil" data-toggle="tooltip"
                               ...
                               --%>     <a href="addLab.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
