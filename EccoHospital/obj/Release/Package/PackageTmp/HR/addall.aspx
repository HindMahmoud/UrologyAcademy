<%@ Page Title="عرض كل الاضافات" Language="C#" MasterPageFile="~/HR/Home.Master" AutoEventWireup="true" CodeBehind="addall.aspx.cs" Inherits="EccoHospital.addall" %>
        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs">
                <ul>
                    ...
                    <li class="bring_right"><a href="">عرض كل الاضافات</a></li>
                </ul>
            </div>
            <!--/End system bath-->
            <div class="page_content">
                <h1 class="heading_title">عرض كل الاضافات</h1>
                    ...
                    <table class="table table-bordered" id="mytable">
                        ...
                        <%  EccoHospital.Models.EccoHospitalEntities db = new EccoHospital.Models.EccoHospitalEntities();
                            var x = (from p in db.add_list 
                                     where p.del == false  select p).ToList();
                        ...
                        <tr style="text-align: center">
                            ...
                            <td>
                                ...
                                --%>     <a href="addall.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
