<%@ Page Title="إضافة اضافات لموظف" Language="C#" MasterPageFile="~/HR/Home.Master" AutoEventWireup="true" CodeBehind="add_addition.aspx.cs" Inherits="EccoHospital.add_addition" %>
        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs">
                <ul>
                    ...
                    <li class="bring_right"><a href="">إضافة اضافات لموظف</a></li>
                </ul>
            </div>
            <!--/End system bath-->
            <div class="page_content">

                <h1 class="heading_title"> إضافة اضافات لموظف</h1>


                <!--Start status alert-->
                <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"><strong>تم الحفظ بنجاح!</strong><br />
                    <a href="add_addition.aspx" class="alert-link">حسناً</a> . </div>
                ...
                <div class="form">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                                <label for="input3" class="col-sm-2 control-label bring_right left_text">الاضافة:</label>
                                <div class="col-sm-10">
                                    ...
                                    <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:eccoConnectionString %>' SelectCommand="SELECT [id], [title] FROM [addition] WHERE ([del] = @del)">
                                        <SelectParameters>
