<%@ Page Title="" Language="C#" MasterPageFile="~/HR/Home.Master" AutoEventWireup="true" CodeBehind="solfaall.aspx.cs" Inherits="EccoHospital.solfaall" %>
        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs">
                <ul>
                    ...
                    <li class="bring_right"><a href="">عرض كل السلفايات</a></li>
                </ul>
            </div>
            <!--/End system bath-->
            <div class="page_content">
                <h1 class="heading_title">عرض كل السلفايات</h1>

                <!--Start status alert-->
                <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"><strong>تم الحفظ بنجاح!</strong><br />
                    <a href="solfaall.aspx" class="alert-link">حسناً</a> . </div>
            ...
            <div class="box-tools">
                ...
                <div class="input-group input-group-sm" style="width: 150px;">
                  <input type="text" name="table_search" id="search" class="form-control pull-left" onkeyup="myFunction1()" placeholder="بحث الموظف ..">
                  <br />
                ...
                <div class="wrap">
                    <table class="table table-bordered" id="mytable">
                        ...
                        <% EccoHospital.Models.EccoHospitalEntities db = new EccoHospital.Models.EccoHospitalEntities();
                            var x = (from ad in db.loan
                                     join it in db.employee on ad.emp_id equals it.id

                                     select new { ad, it }).ToList();
                            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["date1"])) && !String.IsNullOrEmpty(Convert.ToString(Request.QueryString["date2"]))  )
                            {
                                DateTime d1 = Convert.ToDateTime(Request.QueryString["date1"]);
                                ...
                                x = (from ad in db.loan
                                     join it in db.employee on ad.emp_id equals it.id
                                     where ad.date>=d1 && ad.date<=d2 
                                     select new { ad, it }).ToList();
                            }
                            ...
                            if (x != null)
                            {
                                ...
                                foreach (var item in x)
                                {
                                                ...
                                                DateTime d = Convert.ToDateTime(item.ad.date);



                        %>
                        <tr style="text-align: center">
                            <td><a href="loanDetails.aspx?id=<%=item.ad.id %>"><%=i %></a></td>
                            ...
                            <td><%=item.ad.value %></td>
                            <td><%=item.ad.no_months %></td>


                            <td>
                                  <a href="solfaall.aspx?id=<%=item.ad.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
