<%@ Page Title="سجل جزائات موظف" Language="C#" MasterPageFile="~/HR/Home.Master" AutoEventWireup="true" CodeBehind="sancEmp.aspx.cs" Inherits="EccoHospital.sancEmp" %>
        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs">
                <ul>
                    ...
                    <li class="bring_right"><a href="">سجل جزائات موظف  </a></li>
                </ul>
            </div>
            <!--/End system bath-->
            <div class="page_content">
                <h1 class="heading_title">سجل جزائات موظف  </h1>
                    ...
                    <table class="table table-bordered" id="mytable">
                        ...
                        <tr style="text-align: center">
                            ...
                            <td>
                                ...
                                --%>     <a href="sancEmp.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
