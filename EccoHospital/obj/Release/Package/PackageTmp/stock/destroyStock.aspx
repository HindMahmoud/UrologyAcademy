<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="destroyStock.aspx.cs" Inherits="EccoHospital.stock.destroyStock"  MasterPageFile="~/stock/HomeStock.Master"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main_content_container">
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs ">
                <ul>
                    <li class="bring_right"><span class="glyphicon glyphicon-home ">  مخزن الهالك</span></li>
                    <li class="bring_right"><a href="">  مخزن الهالك </a></li>
                </ul>
            </div>
            <!--/End system bath-->
            <div class="page_content">

                <h1 class="heading_title"> مخزن الهالك   </h1>
              ...
              <table class="table table-hover " style="font-weight:bold" id="mytable">
                  <%
                     ...
                     var  x = (from PP in db.stock_destroy
                                 group PP by PP.prod_id into g  select new {g.Key,sum=g.Sum(A=>A.qty) } ).ToList();
                      ...
                      if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["date1"])) && !String.IsNullOrEmpty(Convert.ToString(Request.QueryString["date2"])))
                      {
                          ...
                          DateTime d2 = Convert.ToDateTime(Request.QueryString["date2"]);
                           x = (from PP in db.stock_destroy
                               ...
                               group PP by PP.prod_id into g
                               select new { g.Key, sum = g.Sum(A => A.qty) }).ToList();
                        ...
                        <% if (x != null)
    {
        ...
        foreach (var item in x)
        {
            ...
            int brid = int.Parse(item.Key.ToString());

            EccoHospital.Models.stocks bb = db.stocks.FirstOrDefault(a => a.id == brid);
                        %>
