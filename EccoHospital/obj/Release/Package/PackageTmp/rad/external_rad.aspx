<%@ Page Language="C#" AutoEventWireup="true" masterPageFile="~/rad/MasterPage.Master" CodeBehind="external_rad.aspx.cs" Inherits="EccoHospital.rad.external_rad" %>
                ...
                <div class="home_pass hidden-xs">
                    <ul>
                      <li class="bring_right">  <a  class="btn " data-toggle="modal" data-target="#myModal1"> <span class="notifications">اضافه مريض<i class="fa fa-hand-o-up"></i></span></a></li>
                        ...
                        <li class="bring_right"><a href="">  حجز اشعه لمريض خارجي</a></li>
                    </ul>
                </div>
                <!--/End system bath-->
                <div class="page_content" style="margin-bottom:1px">

                    <h3 class="header">حجز اشعه</h3>


                    <!--Start status alert-->
                    <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="external_rad.aspx" class="alert-link">حسناً</a> . </div>
...
<ContentTemplate>
            ...
            اسم الطبيب   </label>
             ...
             <asp:DropDownList ID="ddldoctors"  CssClass="form-control js-example-placeholder-single select2" runat="server" >
                    ...
                    <%  if (String.IsNullOrEmpty(Request.QueryString["p_id"])&&String.IsNullOrEmpty(Request.QueryString["p_idedit"]))
                        {%>
                    <div>
                       <h3 class="header">عرض كل الأشعه</h3>
    ...
    var x = (from p in db.patient_history
             join n in db.rad_history on p.details_id equals n.id
             where p.type == "اشعه"
    ...
    Response.Write(f.Day + "/" + f.Month + "/" + f.Year); %>
                                ...
                                <td>
                                    <a href="radProfile.aspx?p_id=<%=item.p.p_id%>" style="color:brown;font-size:20px"  data-toggle="tooltip"
                                       data-placement="top" title="profile"><i class="fa fa-arrow-circle-left"></i> </a>
                            </td>
                                <td>
                                    <a href="external_rad.aspx?edit=<%=item.p.id%>" class="glyphicon glyphicon-pencil" data-toggle="tooltip"
                               ...
                               --%>     <a href="external_rad.aspx?id=<%=item.p.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
