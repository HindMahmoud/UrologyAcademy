<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/reception/MasterPage.Master" CodeBehind="savepat.aspx.cs" Inherits="EccoHospital.reception.savepat" %>
        ...
        <div id="myModal1" class="modal fade" role="dialog">
                                ...
                                <div class="col-md-12">
                                   ...
                                   <div class="col-md-4 pull-right">
                                        اسم المريض:
                                    <asp:TextBox placeholder="الاسم " ToolTip="الاسم "  required="true" CssClass="form-control" ID="namepat" runat="server"></asp:TextBox>
                                     ...
                                     <div class="col-md-4 pull-right">
                                       ...
                                       <asp:TextBox ID="m" CssClass="form-control" runat="server"></asp:TextBox>
                                            ...
                                            <div class="modal-footer">
                                              ...
                                              <asp:Button type="button" ValidationGroup="b"  runat="server" ID="btnSave" class="btn btn-danger" style="float:left;"  OnClick="btnSave_Click" Text="حفظ"/>
                                           </div>
                                   </div>
