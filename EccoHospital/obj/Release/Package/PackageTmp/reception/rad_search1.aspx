<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/reception/MasterPage.master" CodeBehind="rad_search1.aspx.cs" Inherits="EccoHospital.reception.rad_search1" %>
                            ...
                            <td><%=item.rad_name %></td>
                              <td>
                                 <% if (item.status == false)
                                    ...
                                    <a href="rad_search1.aspx?p_id=<%=item.p_id %>&&edittxt=<%=item.id%>"  data-toggle="tooltip"
                                 ...
                                 <td>
                                     <a href="rad_search1.aspx?p_id=<%=item.p_id %>&&edit=<%=item.id%>"  data-toggle="tooltip"
                                ...
                                <td> 
                                    <% if (hasFiles != null)
                                        {%>
                                   <a href="../rad/rad_files.aspx?files=<%=item.id%>" class="glyphicon glyphicon-print" data-toggle="tooltip"
