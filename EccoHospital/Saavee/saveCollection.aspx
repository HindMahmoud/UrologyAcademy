<%@ Page Title="" Language="C#" MasterPageFile="~/Saavee/Home.Master" AutoEventWireup="true" CodeBehind="saveCollection.aspx.cs" Inherits="EccoHospital.Saavee.saveCollection" %>
...
<ContentTemplate>
                        ...
                        <div class="col-sm-12 left_text">
                                   <asp:Button ID="btnSave" OnClientClick="target='_blank;'" CssClass="btn btn-success" OnClick="btnSave_Click" runat="server" Text="حفظ و طباعه" />
