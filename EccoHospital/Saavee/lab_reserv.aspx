<%@ Page Title="" Language="C#" MasterPageFile="~/Saavee/Home.Master" AutoEventWireup="true" CodeBehind="lab_reserv.aspx.cs" Inherits="EccoHospital.Saavee.lab_reserv" %>
   ...
   <div class="main_content_container">
            <div class="main_container  main_menu_open">
                ...
                <div class="page_content">
                    ...
                    <h1 class="heading_title">حجز تحاليل</h1>


                    <!--Start status alert-->
                    <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="lab_reserv.aspx" class="alert-link">حسناً</a> . </div>
     ...
     <script>
        Sys.Application.add_load(initdropdown);
             ...
             <asp:DropDownList ID="ddl_lab" CssClass="form-control js-example-placeholder-single select2" runat="server" AutoPostBack="true" OnTextChanged="ddl_lab_TextChanged"></asp:DropDownList>
                    ...
                    <div>
                        <h1 class="heading_title">عرض كل التحاليل</h1>
                        ...
                        <table class="table table-bordered">
                           ...
                           %> 
                            <tr>
                                ...
                                <a href="lab_reserv.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
