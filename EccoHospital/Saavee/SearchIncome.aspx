<%@ Page Title="" Language="C#" MasterPageFile="~/Saavee/Home.Master" AutoEventWireup="true" CodeBehind="SearchIncome.aspx.cs" Inherits="EccoHospital.Saavee.SearchIncome" %>
        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs">
                <ul>
                    ...
                    <li class="bring_right"><a href="index.aspx">الاستقبال </a></li>
                    <li class="bring_right"><a href="SearchIncome.aspx">عرض كل الايرادات</a></li>
                </ul>
            </div>
            <!--/End system bath-->
                ...
                <div class="wrap">
                    <table class="table table-bordered" id="mytable">
                        ...
                        <%  EccoHospital.Models.EccoHospitalEntities db = new EccoHospital.Models.EccoHospitalEntities();
                            var x = (from p in db.savee where p.del == false && (p.out_value==0 ||p.out_value==null) select p).ToList();
                            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["date1"])) && !String.IsNullOrEmpty(Convert.ToString(Request.QueryString["date2"]))  )
                            {
                                DateTime d1 = Convert.ToDateTime(Request.QueryString["date1"]);
                                ...
                                x = (from p in db.savee where p.del == false && p.date >= d1 && p.date <=d2 && (p.out_value==0 ||p.out_value==null)  select p).ToList();
                            }
                        ...
                        <td>
                            <a href="SearchIncome.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
