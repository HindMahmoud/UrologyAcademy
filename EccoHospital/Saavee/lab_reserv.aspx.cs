...
{
    public partial class lab_reserv : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("lab_reserv.aspx");
        ...
        protected void delbtn_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["id"])))
            {
                ...
                if (db.lab_history.Any(a => a.id == p.details_id))
                {
                ...
                if(db.savee.Any(a=>a.type=="تحاليل" && a.item_id==x))
                {
                    savee sss = db.savee.Where(a => a.type == "تحاليل" && a.item_id == x).FirstOrDefault();
                    sss.del = true;
                    db.SaveChanges();
                }
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            {
                MsgBox("ادخل السهر ", this.Page, this);
