<%@ Page Title="" Language="C#" MasterPageFile="~/Saavee/Home.Master" AutoEventWireup="true" CodeBehind="rad_reserv.aspx.cs" Inherits="EccoHospital.Saavee.rad_reserv" %>
                ...
                <div class="home_pass hidden-xs">
                    <ul>
                      <li class="bring_right">  <a  class="btn " data-toggle="modal" data-target="#myModal1"> <span class="notifications">اضافه مريض<i class="fa fa-hand-o-up"></i></span></a></li>
                        ...
                        <li class="bring_right"><a href="">حجز أشعه</a></li>
                    </ul>
                </div>
                <!--/End system bath-->
                <div class="page_content">

                    <h1 class="heading_title">حجز أشعه</h1>


                    <!--Start status alert-->
                    <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="rad_reserv.aspx" class="alert-link">حسناً</a> . </div>
...
<ContentTemplate>
     <script>
        Sys.Application.add_load(initdropdown);
             ...
             <asp:DropDownList ID="ddl_lab" CssClass="form-control" AutoPostBack="true" OnTextChanged="ddl_lab_TextChanged" runat="server"></asp:DropDownList>
                                    </div>
              </div>
                        ...
                        <table class="table table-bordered">
                           ...
                           %> 
                            <tr>
                                ...
                                <td>
                                      <a href="rad_reserv.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
