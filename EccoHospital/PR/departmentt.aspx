<%@ Page Title="" Language="C#" MasterPageFile="~/pr/MasterPage.master" AutoEventWireup="true" CodeBehind="departmentt.aspx.cs" Inherits="EccoHospital.PR.department" %>
            ...
            <div class="main_container  main_menu_open">
                ...
                <div class="home_pass hidden-xs">
                    <ul>
                        ...
                        <li class="bring_right"><a href="">إدارةالأقسام</a></li>
                        <li class="bring_right"><a href="">إضافة قسم جديد</a></li>
                    </ul>
                </div>
                <!--/End system bath-->
                <div class="page_content">
                    ...
                    <!--Start status alert-->
                    <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="departmentt.aspx" class="alert-link">حسناً</a> . </div>
                    ...
                    <div>
                        <h1 class="heading_title">عرض كل الأقسام</h1>
                    
                    <!--Start status alert-->
                    <div runat="server" visible="false" id="Div1" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="departmentt.aspx" class="alert-link">حسناً</a> . </div>
                        ...
                        <table class="table table-bordered">
                            <tr>
                             ...
                             <%  EccoHospital.Models.EccoHospitalEntities db = new EccoHospital.Models.EccoHospitalEntities();
                                 ...
                                 var x = (from p in db.departments 
                           ...
                           %> 
                            <tr>
                                ...
                                <td>
                                    <a href="departmentt.aspx?edit=<%=item.id%>" class="glyphicon glyphicon-pencil" data-toggle="tooltip"
                               ...
                               --%>     <a href="departmentt.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
