<%@ Page Title="" Language="C#" MasterPageFile="~/Accountant/Home.Master" AutoEventWireup="true" CodeBehind="addPayment.aspx.cs" Inherits="EccoHospital.Accountant.addPayment" %>
   ...
   <div class="main_content_container">
            <div class="main_container  main_menu_open">
                ...
                <div class="page_content">
                    ...
                    <h1 class="heading_title">اضافه مصروف</h1>


                    <!--Start status alert-->
                    <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="addPayment.aspx" class="alert-link">حسناً</a> . </div>
                    ...
                    <div class="form">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required type="text" class="form-control" id="txt_byan" placeholder="بيان " runat="server" >
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <input required type="text" class="form-control" id="txt_value" placeholder="القيمه  " runat="server" >
