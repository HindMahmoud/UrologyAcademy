...
{
    public partial class CareCalcu : System.Web.UI.Page
    {
                ...
                if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["edit"])))
                {
                 ...
                 var price = p2.price.ToString();
                  ...
                  var hour = (h2).ToString();
                   ...
                   var totalin =  Math.Round(t,2).ToString();

                    Response.Redirect("RoomsTicket.aspx?t_id=" + p2.ticketId + "&&n=" + "عنايه");
...
h.ticketId=" + p2.ticketId + " ";
        ...
        {
            Response.Redirect("CareCalcu.aspx");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("CareCalcu.aspx?date1=" + from1.Text + "&&date2=" + to1.Text);
            }
        }
