    ...
    <div class="main_content_container">
        <div class="main_container  main_menu_open">
            ...
            <div class="page_content">
                ...
                <h1 class="heading_title">تقارير <%=Request.QueryString["docname"] %>  </h1>
                           ...
                           <div class="col-lg-12 "style="overflow-x:scroll">
                               <table class="table table-hover table-bordered" id="mytable">
                                 ...
                                 <%  
                                     ...
                                     if ( (!String.IsNullOrEmpty(Request.QueryString["docname"])))
                                     {
                                          string c = Request.QueryString["docname"].ToString();
                                           var x = (from ss in db.patient_history  join n in db.doctor on ss.doc_id equals n.id where ss.doc_name==c&& ss.serTypee!="اشعه" && ss.serTypee!="تحاليل" select ss).ToList();

                                         
                                         if ((!string.IsNullOrEmpty(Request.QueryString["servfrom"]) && !string.IsNullOrEmpty(Request.QueryString["servto"])))
                                         {
