<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/rad/MasterPage.Master" CodeBehind="addRad.aspx.cs" Inherits="EccoHospital.rad.addRad" %>
   ...
   <div class="main_content_container">
            <div class="main_container  main_menu_open">
                ...
                <div class="page_content">
                    ...
                    <!--Start status alert-->
                    <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="addRad.aspx" class="alert-link">حسناً</a> . </div>
                    ...
                    <!--Start status alert-->
                    <div runat="server" visible="false" id="Div1" role="alert" class="alert alert-success"> <strong>تم بنجاح!</strong><br /> <a href="addRad.aspx" class="alert-link">حسناً</a> . </div>
                        ...
                        <table class="table table-bordered">
                           ...
                           %> 
                            <tr>
                                ...
                                <td>
                                    <a href="addRad.aspx?edit=<%=item.id%>" class="glyphicon glyphicon-pencil" data-toggle="tooltip"
                               ...
                               --%>     <a href="addRad.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
