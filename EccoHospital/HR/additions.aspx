<%@ Page Title="إضافة اضافات" Language="C#" MasterPageFile="~/HR/Home.Master" AutoEventWireup="true" CodeBehind="additions.aspx.cs" Inherits="StationSales.additions" %>
        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs">
                <ul>
                    ...
                    <li class="bring_right"><a href="">إضافة اضافات</a></li>
                </ul>
            </div>
            <!--/End system bath-->
            <div class="page_content">

                <h1 class="heading_title">إضافة اضافات</h1>


                <!--Start status alert-->
                <div runat="server" visible="false" id="success_m" role="alert" class="alert alert-success"><strong>تم الحفظ بنجاح!</strong><br />
                    <a href="additions.aspx" class="alert-link">حسناً</a> . </div>
                ...
                <div class="form">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label for="input0" class="col-sm-2 control-label bring_right left_text">الاضافة </label>
                            <div class="col-sm-10">
                                <input required type="text" class="form-control" id="txt_name" placeholder="الاسم " runat="server">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input0" class="col-sm-2 control-label bring_right left_text">قيمة الاضافة </label>
                            <div class="col-sm-10">
                ...
                <div class="wrap">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="additions.aspx?edit=<%=item.id%>" class="glyphicon glyphicon-pencil" data-toggle="tooltip"
                                ...
                                --%>     <a href="additions.aspx?id=<%=item.id%>" class="glyphicon glyphicon-remove" data-toggle="tooltip"
