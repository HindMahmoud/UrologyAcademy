...
{
    public partial class sanc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["edit"])))
                {
                    ...
                    EccoHospital.Models.sanctions f = db.sanctions.FirstOrDefault(a => a.id == x);
        ...
        protected void delbtn_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["id"])))
            {
                ...
                if (db.sanctions.Any(a => a.id == x))
                {

                    var p = (from s in db.sanctions where s.id == x select s).FirstOrDefault();
                    p.del = true;
                    db.SaveChanges();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            if (btn.Text != "تعديل")
            {
                ...
                EccoHospital.Models.sanctions u = new EccoHospital.Models.sanctions
                {
