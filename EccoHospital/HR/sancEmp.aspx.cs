...
{
    public partial class sancEmp : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("sancEmp.aspx");
        ...
        protected void show_Click(object sender, EventArgs e)
        {
            if (emp.Text != "" )
            {
                ...
                Response.Redirect("sancEmp.aspx?emp_id=" + em );
            }
        }
        protected void print_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["emp_id"])))
            {
                ...
                string q = @"select * from sanc_list it  where it.del='false' and emp_id ='" + emp_id + "'";
                string cr = "sancEmpRPT.rpt";
                Session["query"] = q;
                Session["cr"] = cr;
