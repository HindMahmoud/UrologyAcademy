...
{
    public partial class add_addition : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["edit"])))
                {
                    ...
                    EccoHospital.Models.add_list f = db.add_list.FirstOrDefault(a => a.id == x);
                    sancc.Text = f.add_id.ToString();
                    txt_value.Value = f.add_value.ToString();
        ...
        {
            Response.Redirect("add_addition.aspx");
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            if (btn.Text != "تعديل")
            {
                ...
                EccoHospital.Models.add_list u = new EccoHospital.Models.add_list
                {

                    emp_name = emp.SelectedItem.ToString(),
                    emp_id = int.Parse(emp.SelectedValue.ToString()),

                    add_id = int.Parse(sancc.SelectedValue.ToString()),

                    add_name = sancc.SelectedItem.ToString(),

                    add_value = float.Parse(txt_value.Value),
                    date = DateTime.Now,
                    user_id = user_id,
                    user_name = n,
                    del = false
            ...
            else
            {
                ...
                f.add_id = int.Parse(sancc.SelectedValue.ToString());

                f.add_name = sancc.SelectedItem.ToString();

                f.add_value = float.Parse(txt_value.Value);
        ...
        protected void sancc_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (sancc.Text != "")
            {
                ...
                EccoHospital.Models.addition emp = db.addition.FirstOrDefault(a => a.id == s);
