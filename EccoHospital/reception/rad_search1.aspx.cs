...
{
    public partial class rad_search1 : System.Web.UI.Page
    {
        ...
        protected void show_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("rad_search1.aspx?date1=" + from1.Text + "&&date2=" + to1.Text);
            }
        }
        ...
        protected void btn_add_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["edittxt"])))
            {
                ...
                else
                {
                    ...
                    txt_result.Text = "";
                    Response.Redirect("rad_search1.aspx?p_id=" + p_i);
