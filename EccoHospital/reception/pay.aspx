<%@ Page Title="" Language="C#" MasterPageFile="~/reception/MasterPage.master" AutoEventWireup="true" Inherits="reception_pay" Codebehind="pay.aspx.cs" %>
     ...
     <div class="main_content_container">
        <div class="main_container  main_menu_open">
            ...
            <div class="page_content">
                ...
                <h1 class="heading_title">   حساب تذكرة  </h1>
                            ...
                            <div class="col-xs-12 table-bordered" style="background-color:pink">
                             ...
                             <div class="col-xs-12 pull-left">
                                 ...
                                 <div class="col-xs-12 pull-left">
                                        ...
                                        <label for="middle-name" class="control-label hidden-print">الباقى على المريض   :</label>
                                        <div>


                                            <asp:TextBox ID="last" Width="50%" AutoPostBack="true" OnTextChanged="txt_code_TextChanged" CssClass="form-control" runat="server"></asp:TextBox>
                                            <asp:RegularExpressionValidator ValidationGroup="b" CssClass="text-red" ID="RegularExpressionValidator6"
                                                ControlToValidate="last" runat="server"
                                                ErrorMessage="خطأ في ادخال الباقى"
                                                ValidationExpression="^[0-9]\d{0,9}(\.\d{1,3})?%?$">
                                            </asp:RegularExpressionValidator>
                                             <asp:RequiredFieldValidator
                                            CssClass="text-red text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator5" ControlToValidate="last" ErrorMessage="ادخل الباقى ">
                                        </asp:RequiredFieldValidator>
                                        </div>
                                    </div>
