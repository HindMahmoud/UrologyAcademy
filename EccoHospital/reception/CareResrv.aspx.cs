...
{
    public partial class CareResrv : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (db.room.Any())
                {
                    var cr = (from d in db.room where d.flag == false && d.type == "عنايه" select d).ToList();
        ...
        {
            Response.Redirect("CareResrv.aspx");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (namepat.Text != "")
            {
               ...
               // Response.Redirect("RoomReserv.aspx");
            }
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("CareResrv.aspx?date1=" + from1.Text + "&&date2=" + to1.Text);
            }
        }
    }
}