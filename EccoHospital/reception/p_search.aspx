        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="page_content">
              ...
              <asp:TextBox CssClass="form-control" ID="ssi_st"  runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-5 pull-right">
                                   كود المريض :
              <asp:TextBox CssClass="form-control" ID="TxtCode"  runat="server" OnTextChanged="TxtCode_TextChanged" AutoPostBack="true"></asp:TextBox>
              ...
              <asp:TextBox CssClass="form-control" ID="p_name"  runat="server"></asp:TextBox>
                                     ...
                                     <div class="col-md-5 pull-right">
                                    اسم المرافق :
                                    <asp:DropDownList ID="DDfriend" runat="server"  CssClass="form-control js-example-placeholder-single select2"></asp:DropDownList>
                                </div>
              ...
              <asp:TextBox CssClass="form-control" ID="p_gov"  runat="server"></asp:TextBox>
                                 ...
                                 <%  
                                     ...
                                     if (!string.IsNullOrEmpty(Request.QueryString["ssi"]) || !string.IsNullOrEmpty(Request.QueryString["name"]) || !string.IsNullOrEmpty(Request.QueryString["city"]) || !string.IsNullOrEmpty(Request.QueryString["govv"]) || !string.IsNullOrEmpty(Request.QueryString["mobb"]) || !string.IsNullOrEmpty(Request.QueryString["city"]) || !string.IsNullOrEmpty(Request.QueryString["govv"]) || !string.IsNullOrEmpty(Request.QueryString["code"])  || !string.IsNullOrEmpty(Request.QueryString["city"]) || !string.IsNullOrEmpty(Request.QueryString["govv"]) || !string.IsNullOrEmpty(Request.QueryString["mobb"]) || !string.IsNullOrEmpty(Request.QueryString["city"]) || !string.IsNullOrEmpty(Request.QueryString["code"]))
                                     {
                                         ...
                                         string x5 = (Request.QueryString["code"].ToString());
                                 //        string x6 = (Request.QueryString["friend"].ToString());
                                         ...
                                         if (x4 != "")
                                         {
                                           ...
                                           if (x5 != "")
                                         {
                                             x = db.patient.Where(c=>c.code==x5).ToList();
                                         }
