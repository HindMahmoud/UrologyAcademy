...
{
    public partial class savepat : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("savepat.aspx");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (namepat.Text != "")
            {
                var pp = (from m in db.patient where (m.phone == txtPhone.Text)||(m.ssi== natPatient.Text) select m).FirstOrDefault();
        ...
        protected void btn_enter_Click(object sender, EventArgs e)
        {
            if (patientlist.Text != "")
            {
                ...
                Response.Redirect("saveColl.aspx?t_id=" + t_id);
            }
        }
