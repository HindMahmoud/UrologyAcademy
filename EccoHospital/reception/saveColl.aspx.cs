...
{
    public partial class saveColl : System.Web.UI.Page
    {
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["t_id"])))
            {
                ...
                if (ddl_lab.SelectedValue == "" && ddl_rad.SelectedValue == "" && ddl_servic.SelectedValue == "" && ddlblood.SelectedValue == "")
                {
                ...
                else
                {
                    ...
                    else if (ddl_servic.SelectedValue != "")
                    {
                    ...
                    Response.Redirect("saveColl.aspx?t_id=" + x);
